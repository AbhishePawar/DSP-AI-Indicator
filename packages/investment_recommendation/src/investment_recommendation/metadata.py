"""Version and provenance metadata for Investment Recommendation."""
...
RECOMMENDATION_VERSION = "0.1.0-investment-recommendation"
FRAMEWORK_VERSION = "0.1.0-core"


@dataclass(frozen=True, slots=True)
class InvestmentRecommendationMetadata:
    engine_version: str
