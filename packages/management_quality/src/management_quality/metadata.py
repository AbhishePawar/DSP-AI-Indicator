"""Version and provenance metadata for Management Quality Intelligence."""
...
MANAGEMENT_QUALITY_VERSION = "0.1.0-management-quality"
FRAMEWORK_VERSION = "0.1.0-core"


@dataclass(frozen=True, slots=True)
class ManagementMetadata:
    """Immutable provenance for a Management Quality analysis artifact."""
