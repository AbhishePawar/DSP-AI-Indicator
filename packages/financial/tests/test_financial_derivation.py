...
Uses TCS/INR statement figures from authenticated-statement fixtures
(not live market guesses): revenue 150000, net income 30000,
total equity 120000.
"""
...
# Authenticated INR annual figures for deterministic derivation tests.
_TCS_NI = 30_000.0
