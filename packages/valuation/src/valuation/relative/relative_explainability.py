"""Explainability helpers for Relative Valuation (research-only)."""
...
__all__ = ["RelativeExplainedValue", "explain_step", "explain_many"]

RelativeExplainedValue = ExplainabilityRecord
