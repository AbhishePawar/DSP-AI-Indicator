"""Shared fixtures for Investment Committee tests."""
...
@pytest.fixture
def committee_inputs(financial_analysis, business_quality_analysis):
    ...
    eq = EarningsQualityEngine().analyze(financial_analysis, business_quality_analysis)
    gq = GrowthQualityEngine().analyze(financial_analysis, business_quality_analysis)
    ...
    recommendation = InvestmentRecommendationEngine().analyze(
        valuation=valuation,
        business_quality=bq,
        economic_moat=em,
        management_quality=mq,
...
@pytest.fixture
def overvalued_committee_inputs(financial_analysis, business_quality_analysis):
    em = EconomicEngine().analyze(financial_analysis, business_quality_analysis)
    mq = ManagementEngine().analyze(financial_analysis, business_quality_analysis)
    fs = FinancialStrengthEngine().analyze(
        financial_analysis, business_quality_analysis
