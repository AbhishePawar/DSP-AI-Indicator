"""Explainability helpers for Earnings Power Value (research-only)."""
...
__all__ = ["EpvExplainedValue", "explain_step", "explain_many"]

EpvExplainedValue = ExplainabilityRecord
