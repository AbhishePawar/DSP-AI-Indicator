"""Shared fixtures for Economic Moat Intelligence tests."""
...
def financial_analysis() -> FinancialAnalysis:
    """Create a real public FinancialAnalysis without an external provider."""
...
def business_quality_analysis(financial_analysis: FinancialAnalysis):
    """Create a real public BusinessQualityAnalysis from FinancialAnalysis."""
