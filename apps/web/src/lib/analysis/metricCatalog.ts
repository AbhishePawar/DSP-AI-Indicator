...
export const BUSINESS_QUALITY_METRICS: MetricTemplate[] = [
  {
    ...
    meaning:
      "Overall quality of the underlying enterprise as cited by research artifacts.",
    whyItMatters:
      "Higher-quality businesses tend to compound more reliably over long horizons.",
    investorTakeawayWhenMissing:
      "Investigate segment mix and ROIC trends in filings when data arrives.",
    learnMore: "term:roic",
    aiPrompts: [
  ...
  },
  {
    ...
    investorTakeawayWhenMissing:
      "Compare switching costs and market share narratives in the annual report.",
    learnMore: "term:moat",
    aiPrompts: ["Describe the competitive position", "What threatens this position?"],
  },
  {
    ...
    investorTakeawayWhenMissing:
      "Review multi-year revenue history when fundamentals are available.",
    learnMore: "term:cagr",
  ...
  },
  {
    ...
    investorTakeawayWhenMissing:
      "Inspect margin trends in the income statement when wired.",
  ...
  },
  {
    ...
    investorTakeawayWhenMissing:
      "Read capital allocation commentary in the latest annual report.",
    learnMore: "term:roic",
  ...
  },
  {
    ...
    whyItMatters:
      "Low predictability widens intrinsic value ranges and raises research caution.",
    investorTakeawayWhenMissing:
      "List key uncertainties before sizing any research conclusion.",
...
export const FINANCIAL_STRENGTH_METRICS: MetricTemplate[] = [
  {
    ...
    investorTakeawayWhenMissing:
      "Pull multi-year revenue CAGR from filings when available.",
    learnMore: "term:cagr",
  ...
  },
  {
    ...
    investorTakeawayWhenMissing:
      "Compare operating margin to peers when metrics arrive.",
    learnMore: "term:free_cash_flow",
  ...
  },
  {
    ...
    investorTakeawayWhenMissing:
      "Review net income quality when statements are connected.",
    learnMore: "term:free_cash_flow",
  ...
  },
  {
    ...
    whyItMatters:
      "Helps gauge capital efficiency for equity holders (context required).",
    investorTakeawayWhenMissing:
      "Interpret ROE with leverage context once fundamentals load.",
    learnMore: "term:roic",
  ...
  },
  {
    ...
    investorTakeawayWhenMissing:
      "Await calculated ROCE from the valuation/fundamentals envelope.",
    learnMore: "term:roic",
  ...
  },
  {
    ...
    investorTakeawayWhenMissing:
      "Review debt maturity and covenants in the annual report.",
  ...
  },
  {
    ...
    investorTakeawayWhenMissing:
      "Check interest coverage once income statement metrics are present.",
  ...
  },
  {
    ...
    investorTakeawayWhenMissing:
      "Inspect cash flow statement when fundamentals are wired.",
    learnMore: "term:free_cash_flow",
