"""Explainability helpers for Asset-Based Valuation (research-only)."""
...
__all__ = ["AssetExplainedValue", "explain_step", "explain_many"]

AssetExplainedValue = ExplainabilityRecord
