...
satisfied by investment credentials.
  ...
  INVESTMENT DOMAIN — market data. Owned by ``data_engine`` / composition.
  Auth boot, login, OTP, magic-link, Google OAuth, JWT/session, and
  ``/health/ready`` must not require investment credentials.
