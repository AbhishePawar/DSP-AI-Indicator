...
def create_app(
    *,
    ...
    if security is None and (
        ...
        # Auth-domain JWT only — never market-data / investment credentials.
    ...
    # Client authentication must boot independently of market-data availability.
