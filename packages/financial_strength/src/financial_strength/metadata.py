"""Version and provenance metadata for Financial Strength Intelligence."""
...
FINANCIAL_STRENGTH_VERSION = "0.1.0-financial-strength"
FRAMEWORK_VERSION = "0.1.0-core"


@dataclass(frozen=True, slots=True)
class FinancialStrengthMetadata:
    """Immutable provenance for a Financial Strength analysis artifact."""
