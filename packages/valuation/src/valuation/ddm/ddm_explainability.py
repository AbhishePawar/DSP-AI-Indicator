"""Explainability helpers for Dividend Discount Model (research-only)."""
...
__all__ = ["DdmExplainedValue", "explain_step", "explain_many"]

DdmExplainedValue = ExplainabilityRecord
