    ...
    <Card>
      ...
      <CardBody>
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          <PortfolioCard label="Sector Count" value={diversification.sectorCount} />
          <PortfolioCard label="Exchange Count" value={diversification.exchangeCount} />
          <PortfolioCard label="Country Count" value={diversification.countryCount} />
          <PortfolioCard
