  ...
  return (
    ...
    >
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <MetricCell label="Generation timestamp" field={view.generationTimestamp} />
        <MetricCell label="Market data timestamp" field={view.marketDataTimestamp} />
        <MetricCell
        ...
        <MetricCell label="Calculation metadata" field={view.calculationMetadata} />
