...
_FMP_KEY = "phase1-test-fmp-api-key-not-real"
...
def test_b_ready_probe_accepts_traffic_without_fmp_key(
    monkeypatch: pytest.MonkeyPatch, platform: DSPPlatform
) -> None:
    """Cloud Run / Docker HEALTHCHECK must not require FMP for API readiness."""
    from api_platform import create_app
