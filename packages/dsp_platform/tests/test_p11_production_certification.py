...
def test_dsp_platform_version_is_1_6_0() -> None:
...
def test_production_manifest_decision() -> None:
    ...
    assert data["backendVersion"] == "1.6.0"
    assert data["frontendVersion"] == "2.0.0-rc"
    assert data["decision"] == "READY_WITH_MINOR_CONDITIONS"
    assert data["apiContract"] == "v1.0.0-rc1"
